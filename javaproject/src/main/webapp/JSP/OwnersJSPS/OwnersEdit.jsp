...
<body>
	<%
		if(request.getParameter("ownerno")!=null)
		{
			Owners	owner=new OwnersService().find(Integer.parseInt(request.getParameter("ownerno")));
			request.setAttribute("owner",owner);
		}
	%>
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">OwnerDetails</a>
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="Owners.jsp">
    ...
    <div class="content">
        <form action="OwnersEdit.jsp?ownerno=${param.ownerno }" method="post">
            <div class="container form-container">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <input type="text" class="form-control custom-input" placeholder="Owner Name" aria-label="Owner Name" name="ownername" id="ownername" value="${owner.name}">
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <input type="text" class="form-control custom-input" placeholder="Address" aria-label="Address" name="address1" id="address" value="${owner.address1}">
                            </div>
                            <div class="col-md-12 mb-3">
                                <input type="text" class="form-control custom-input" placeholder="Address" aria-label="Address" name="address2" id="address" value="${owner.address2}">
                            </div>
                            <div class="col-md-6 mb-3">
                                <select class="form-select custom-input" name="selectcountry" id="selectcountry">
                                    ...
                                    %>
                                    <option value="${owner.country.countryNo }">${owner.country.country }</option>
                            ...
                            <div class="col-md-6 mb-3">
                                <select class="form-select custom-input" name="selectstate" id="selectstate">
                                    ...
                                    %>
                                    <option value="${owner.state.stateNo}">${owner.state.stateName}</option>
                        ...
                        <div class="row">
                        	 <div class="col-md-6 mb-3">
                                <select class="form-select custom-input" name="selectcity" id="selectcity">
                                    ...
                                    %>
                                    <option value="${owner.city.cityNo}">${owner.city.cityName}</option>
                              ...
                              <div class="col-md-6 mb-3">
                                    <input type="text" class="form-control custom-input" placeholder="Pincode" aria-label="Pincode" name="Pincode" id="Pincode" value="${owner.pincode}">
                               </div>
                        </div>
                    </div>
                </div>
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        <div class="container form-container">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <input type="text" class="form-control custom-input" placeholder="Phone Number" aria-label="Phone Number" name="phonenumber" id="phonenumber" value="${owner.phoneNumber}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <input type="text" class="form-control custom-input" placeholder="Mobile Number" aria-label="Mobile Number" name="mobilenumber" id="mobilenumber" value="${owner.mobileNumber}">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="container form-container">
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <input type="text" class="form-control custom-input" placeholder="Bank" aria-label="Bank" name="bank" id="bank" value="${owner.bankName}">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <input type="text" class="form-control custom-input" placeholder="Account Number" aria-label="Account Number" name="accountnumber" id="accountnumber" value="${owner.bankAccount}">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <input type="text" class="form-control custom-input" placeholder="Pan Number" aria-label="Pan Number" name="pannumber" id="pannumber" value="${owner.PAN}">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <c:choose>
        <c:when test="${param.btn == 'save'}">
                <jsp:useBean id="owners" class="com.iss.models.Owners" scope="request">
                <jsp:setProperty name="owners" property="name" value="${param.ownername}" />
                <jsp:setProperty name="owners" property="address1" value="${param.address1}" />
                <jsp:setProperty name="owners" property="address2" value="${param.address2}" />
                <jsp:setProperty name="owners" property="pincode" value="${param.Pincode}" />
                <jsp:setProperty name="owners" property="phoneNumber" value="${param.phonenumber}" />
                <jsp:setProperty name="owners" property="mobileNumber" value="${param.mobilenumber}" />
                <jsp:setProperty name="owners" property="bankName" value="${param.bank}" />
                <jsp:setProperty name="owners" property="bankAccount" value="${param.accountnumber}" />
                <jsp:setProperty name="owners" property="PAN" value="${param.pannumber}" />
                <jsp:setProperty name="owners" property="ownerNo" value="${param.ownerno}" />
            </jsp:useBean>
                <% 
                    try {
                    	...
                    	owners.setCity(city);
                    	owners.setCountry(country);
                    	owners.setState(state);
                        new OwnersService().edit(owners);
                    } catch(Exception ex) {
                        ex.printStackTrace();        
                    }
        ...
        <c:when test="${param.btn=='clear'}">
        	<%
        		try{
        				response.sendRedirect("OwnersEdit.jsp");
        		}catch(Exception ex) {
                    ex.printStackTrace();        
                }
        	%>
