...
<body>
	<%
		...
		{
			Employees	emp=new EmployeesService().find(Integer.parseInt(request.getParameter("empno")));
    ...
    <div class="content">
        <form action="EmployeeEdit.jsp?empno=${param.empno }" method="post">
            <div class="container form-container">
                <div class="row">
                    <div class="col-md-4 mb-3">
                        <input type="text" class="form-control custom-input" placeholder="Employee Name" aria-label="Employee Name" name="employeename" id="employeename" value="${emp.name }">
                    </div>
                    <div class="col-md-4 mb-3">
                    	<select class="form-select custom-input" name="selectemptype" id="selectemptype">
                                    ...
                                    %>
                                    <option value="${emp.employeeType }">${emp.employeeType }</option>
                    ...
                    <div class="col-md-4 mb-3">
                        <input type="text" class="form-control custom-input" placeholder="Email Address" aria-label="Email Address" name="emailaddress" id="emailaddress" value="${emp.emailAddress }">
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <input type="text" class="form-control custom-input" placeholder="Address" aria-label="Address" name="address1" id="address" value="${emp.addressLine1 }">
                            </div>
                            <div class="col-md-12 mb-3">
                                <input type="text" class="form-control custom-input" placeholder="Address" aria-label="Address" name="address2" id="address" value="${emp.addressLine2 }">
                            </div>
                            <div class="col-md-6 mb-3">
                                <select class="form-select custom-input" name="selectcountry" id="selectcountry">
                                    ...
                                    %>
                                    <option value="${emp.country.countryNo}">${emp.country.country}</option>
                            ...
                            <div class="col-md-6 mb-3">
                                <select class="form-select custom-input" name="selectstate" id="selectstate">
                                    ...
                                    %>
                                    <option value="${emp.state.stateNo }">${emp.state.stateName }</option>
                        ...
                        <div class="row">
                        	 <div class="col-md-6 mb-3">
                                <select class="form-select custom-input" name="selectcity" id="selectcity">
                                    ...
                                    %>
                                    <option value="${emp.city.cityNo}">${emp.city.cityName}</option>
                              ...
                              <div class="col-md-6 mb-3">
                                    <input type="text" class="form-control custom-input" placeholder="Pincode" aria-label="Pincode" name="Pincode" id="Pincode" value="${emp.pincode}">
                               </div>
                        </div>
                    </div>
                </div>
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        <div class="container form-container">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <input type="text" class="form-control custom-input" placeholder="Phone Number" aria-label="Phone Number" name="phonenumber" id="phonenumber" value="${emp.phoneNumber}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <input type="text" class="form-control custom-input" placeholder="Mobile Number" aria-label="Mobile Number" name="mobilenumber" id="mobilenumber" value="${emp.mobileNumber}">
                                </div>
                            </div>
                        </div>
                    </div>
                 ...
                 <div class="card mt-3">
                    ...
                    <div class="card-body">
                        <div class="container form-container">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <input type="text" class="form-control custom-input" placeholder="User Name" aria-label="User Name" name="username" id="username" value="${emp.username}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <input type="text" class="form-control custom-input" placeholder="Password" aria-label="Password" name="pass" id="pass" value="${emp.password}">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="container form-container">
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <input type="text" class="form-control custom-input" placeholder="Bank" aria-label="Bank" name="bank" id="bank" value="${emp.bankName}">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <input type="text" class="form-control custom-input" placeholder="Account Number" aria-label="Account Number" name="accountnumber" id="accountnumber" value="${emp.bankAccount}">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <input type="text" class="form-control custom-input" placeholder="Pan Number" aria-label="Pan Number" name="pannumber" id="pannumber" value="${emp.PAN}">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="container form-container">
                            <div class="row">
                                <div class="col-md-2 mb-3">
                                     <div class="form-check">
								      <input type="checkbox" class="form-check-input" id="radio1" name="cities" value="true" ${emp.cities == 'true' ? 'checked' : ''}>
								      <label class="form-check-label" for="radio1">Cities</label>
								    </div>
                                </div>
                                <div class="col-md-2 mb-3">
									<div class="form-check">
								      <input type="checkbox" class="form-check-input" id="radio1" name="states" value="true" ${emp.states == 'true' ? 'checked' : ''}>
								      <label class="form-check-label" for="radio1">States</label>
								    </div>   
	                             </div>
                                <div class="col-md-2 mb-3">
									<div class="form-check">
								      <input type="checkbox" class="form-check-input" id="radio1" name="countrys" value="true" ${emp.countries == 'true' ? 'checked' : ''}>
								      <label class="form-check-label" for="radio1">Countries</label>
								    </div>
                                </div>
                                <div class="col-md-2 mb-3">
									<div class="form-check">
								      <input type="checkbox" class="form-check-input" id="radio1" name="vehicles" value="true" ${emp.vehicles == 'true' ? 'checked' : ''}>
								      <label class="form-check-label" for="radio1">Vehicles</label>
								    </div>
                                </div>
                                <div class="col-md-2 mb-3">
									<div class="form-check">
								      <input type="checkbox" class="form-check-input" id="makeCheckbox" name="make" value="true" ${emp.vehicleMakes == 'true' ? 'checked' : ''}>
								      <label class="form-check-label" for="radio1">Make</label>
								    </div>
                                </div>
                                 <div class="col-md-2 mb-3">
									<div class="form-check">
								      <input type="checkbox" class="form-check-input" id="radio1" name="models" value="true" ${emp.vehicleModels == 'true' ? 'checked' : ''}>
                            ...
                            <div class="row">
                                <div class="col-md-2 mb-3">
                                     <div class="form-check">
								      <input type="checkbox" class="form-check-input" id="radio1" name="employees" value="true" ${emp.employees == 'true' ? 'checked' : ''}>
								      <label class="form-check-label" for="radio1">Employees</label>
								    </div>
                                </div>
                                <div class="col-md-2 mb-3">
									<div class="form-check">
								      <input type="checkbox" class="form-check-input" id="radio1" name="customers" value="true" ${emp.customers == 'true' ? 'checked' : ''}>
								      <label class="form-check-label" for="radio1">Customers</label>
								    </div>   
	                             </div>
                                <div class="col-md-2 mb-3">
									<div class="form-check">
								      <input type="checkbox" class="form-check-input" id="radio1" name="owners" value="true" ${emp.owners == 'true' ? 'checked' : ''} >
								      <label class="form-check-label" for="radio1">Owners</label>
								    </div>
                                </div>
                                <div class="col-md-2 mb-3">
									<div class="form-check">
								      <input type="checkbox" class="form-check-input" id="radio1" name="drivers" value="true" ${emp.drivers == 'true' ? 'checked' : ''}>
								      <label class="form-check-label" for="radio1">Drivers</label>
								    </div>
                                </div>
                                <div class="col-md-2 mb-3">
									<div class="form-check">
								      <input type="checkbox" class="form-check-input" id="radio1" name="reservations" value="true" ${emp.rentals == 'true' ? 'checked' : ''}>
    ...
    <c:choose>
        <c:when test="${param.btn == 'save'}">
                 ...
                 <jsp:setProperty name="employees" property="employeeNo" value="${param.empno}" />
                ...
                <% 
                    try {
                        ...
                        new EmployeesService().edit(employees);
