...
<body>
	<%
		if(request.getParameter("customerno")!=null)
		{
			...
			int customerno=Integer.parseInt(request.getParameter("customerno"));
				Customers	customer=new CustomerService().find(customerno);
					request.setAttribute("customer",customer);
		}
	%>
    <div class="content">
        <form action="${pageContext.request.contextPath}/JSP/ShareSourceJSPS/CustomerEditSource.jsp?customerno=${customer.customerNo}" method="post">
    ...
    <c:choose>
        ...
        <c:when test="${param.btn=='clear'}">
        	<%
        		try{
        				response.sendRedirect("CustomersEditSource.jsp");
        		}catch(Exception ex) {
                    ex.printStackTrace();        
                }
        	%>
