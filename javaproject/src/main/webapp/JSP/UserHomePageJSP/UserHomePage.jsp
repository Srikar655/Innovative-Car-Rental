...
<body>
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="CustomerSignUp.jsp">
    ...
    <div class="content">
    	<form action="UserService.jsp" method="post">
	        <div class="row">
	        	<div class="col-md-3">
	        				<c:choose>
	        			...
	        			<input type="password" class="form-control custom-input" placeholder="Enter Password" aria-label="Enter Password" name="password" id="password">
	              		<button class="custom-btn" type="submit" name="btn" value="login">Login</button><br>
	       				<div class="card">
	       					...
	       					<div class="card-body scroll-pane">
	       						...
	       						<c:forEach items="${typeslist}" var="temp">
	       							&#8594;<a href="UserHomePage.jsp?type=${temp.type}">${temp.type}</a><br>
	       						</c:forEach>
	       					</div>
	       				</div>
	       				<div class="card">
	       					...
	       					<div class="card-body scroll-pane">
	       						...
	       						<c:forEach items="${makeslist}" var="temp">
	       							&#8594;<a href="UserHomePage.jsp?make=${temp.name}">${temp.name}</a><br>
	       						</c:forEach>
	       					</div>
	        		...
	        		<div class="row">
	        			<c:choose>
	        				...
	        				<c:when test="${param.btn eq 'details' }">
	        					...
	        					<c:set var="path" value="/simple-webapp/JSP/UserHomePageJSP/UserHomePage.jsp" scope="session"/>
