...
<body>
  <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
    <div class="container-fluid">
      <a class="navbar-brand" href="#">VehcileMakesDetails</a>
  ...
  <div class="content">
    <form action="VehicleMakesAdd.jsp" method="post">
      <div class="container form-container">
        <div class="row">
          <div class="col-md-6 offset-md-3">
            <div class="custom-input-group">
              <input type="text" class="form-control custom-input" placeholder="Enter Vehicle Make" aria-label="Enter Vehicle Make" name="t1" id="t1">
      ...
      <c:when test="${param.btn == 'add'}">
        <c:if test="${param.t1 != 'null'}">
          <jsp:useBean id="vehiclemakes" class="com.iss.models.VehicleMakes" scope="request">
                ...
                <% 
                    try {
                        new VehicleMakesService().add(vehiclemakes);
                        response.sendRedirect("VehicleMakesAdd.jsp");
                    } catch(Exception ex) {
                        ex.printStackTrace();        
                    }
                %>
