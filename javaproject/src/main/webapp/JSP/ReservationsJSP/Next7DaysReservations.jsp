...
<%
	...
	List<Rentals> list=rs.getSevenDays();
            ...
            <%
	            try {
		            	if(request.getParameter("rentalno")!=null)
		                {
		                    ...
		                    cs.edit(rental);
		                    response.sendRedirect("Next7DaysReservations.jsp");
		                }
	            } catch(Exception ex) {
	                ex.printStackTrace();		
	            }
                        ...
                        <tbody>
                            <c:forEach items="${list}" var="temp">
                                <tr>
                                    ...
                                    <td><a href="Next7DaysReservations.jsp?val=Cancelled&rentalno=${temp.renatalNo}"><i>&times;</i></a></td>
                                </tr>
                            </c:forEach>
                        </tbody>
                    </table>
