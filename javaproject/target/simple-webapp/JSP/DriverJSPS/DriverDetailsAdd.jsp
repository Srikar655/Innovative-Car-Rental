...
<body>
    ...
    <div class="content">
        <form action="DriverDetailsAdd.jsp" method="post">
            <div class="container form-container">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <input type="text" class="form-control custom-input" placeholder="Driver Name" aria-label="Driver Name" name="drivername" id="drivername">
                    </div>
                    <div class="col-md-6 mb-3">
                        <input type="text" class="form-control custom-input" placeholder="License Number" aria-label="License Number" name="licensenumber" id="licensenumber">
                    </div>
                </div>
            </div>
        ...
        <c:when test="${param.btn == 'add'}">
                ...
                <% 
                    try {
                        ...
                        new DriverDetailsService().add(drivers);
