...
<body>
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="/simple-webapp/JSP/CustomerJSPS/CustomersAdd.jsp">
	...
	<c:set var="path" value="/JSP/UserHomePageJSP/UserHomePageService.jsp" scope="session"/>
	<%@ include file="/JSP/ShareSourceJSPS/CustomerEditSource.jsp" %>
    <footer class="footer">
        <div class="container">
