...
<body>
    ...
    <div class="content">
        <form action="VehiclesAdd.jsp?save=save" method="post" enctype="multipart/form-data">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <select class="form-select custom-input" name="selectcountry" id="selectcountry" onchange=<redirect>"VehiclesAdd.jsp?value=countryselected"</redirect>>
                                    <%
