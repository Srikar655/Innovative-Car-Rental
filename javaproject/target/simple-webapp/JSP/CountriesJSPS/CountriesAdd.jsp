...
<body>
  ...
  <div class="content">
    <form action="CountriesAdd.jsp" method="post">
      <div class="container form-container">
        <div class="row">
          <div class="col-md-6 offset-md-3">
            <div class="custom-input-group">
              <input type="text" class="form-control custom-input" placeholder="Enter Country" aria-label="Enter Country" name="t1" id="t1">
      ...
      <c:when test="${param.btn == 'add'}">
        <c:if test="${param.t1 != 'null'}">
          <jsp:useBean id="country" class="com.iss.models.Countries" scope="request">
                ...
                <% 
                    try {
                        new CountriesService().add(country);
                        response.sendRedirect("CountriesAdd.jsp");
                    } catch(Exception ex) {
                        ex.printStackTrace();        
                    }
                %>
