...
<body>
	<%
		...
		{
			Countries	con=new CountriesService().find(Integer.parseInt(request.getParameter("conid")));
  ...
  <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
    <div class="container-fluid">
      ...
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="Countries.jsp"><img src="https://th.bing.com/th/id/OIP.D5Npngc53EqWc9tZ6VFytAHaHa?rs=1&pid=ImgDetMain" alt="Logo" style="width:40px;" class="rounded-pill"></a>
        </li>
        <li class="nav-item">
  ...
  <form action="CountriesEdit.jsp?conid=${param.conid}" method="post" class="flex-grow-1">
    <div class="container form-container">
      <div class="row">
        <div class="col-md-6 offset-md-3">
          <div class="custom-input-group">
            <input type="text" class="form-control custom-input" placeholder="Enter Country" aria-label="Enter Country" name="t1" id="t1" value="${con.country}">
    ...
    <c:when test="${param.btn == 'Edit'}">
      <c:if test="${param.t1 != 'null'}">
        <jsp:useBean id="country" class="com.iss.models.Countries" scope="request">
                <jsp:setProperty name="country" property="country" value="${param.t1}" />
                <jsp:setProperty name="country" property="countryNo" value="${param.conid}" />
                
            </jsp:useBean>
                <% 
                    try {
                        new CountriesService().edit(country);
                        response.sendRedirect("CountriesEdit.jsp");
                    } catch(Exception ex) {
                        ex.printStackTrace();        
                    }
                %>
