...
<%
	...
	List<Rentals> list=rs.getTomorrows();
            ...
            <%
	            try {
		            	if(request.getParameter("rentalno")!=null)
		                {
		                    ...
		                    cs.edit(rental);
		                    response.sendRedirect("NextTwoDaysReservations.jsp");
		                }
	            } catch(Exception ex) {
	                ex.printStackTrace();		
	            }
                        ...
                        <tbody>
                            <c:forEach items="${list}" var="temp">
                                <tr>
                                    ...
                                    <td><a href="NextTwoDaysReservations.jsp?val=Cancelled&rentalno=${temp.renatalNo}"><i>&times;</i></a></td>
                                </tr>
                            </c:forEach>
                        </tbody>
                    </table>
