...
<body>
    ...
    <div class="content">
        <form action="OwnersAdd.jsp" method="post">
            <div class="container form-container">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <input type="text" class="form-control custom-input" placeholder="Owner Name" aria-label="Owner Name" name="ownername" id="ownername">
                    </div>
                </div>
            </div>
         ...
         <jsp:useBean id="owners" class="com.iss.models.Owners" scope="request">
                ...
                <% 
                    try {
                        ...
                        new OwnersService().add(owners);
                        response.sendRedirect("OwnersAdd.jsp");
                    } catch(Exception ex) {
                        ex.printStackTrace();        
                    }
                %>
