...
<body>
  ...
  <div class="content">
    <form action="StatesAdd.jsp" method="post">
        ...
        <div class="row">
          <div class="col-md-6 offset-md-3">
            <div class="custom-input-group">
              ...
              <input type="text" class="form-control custom-input" placeholder="Enter State" aria-label="Enter State" name="t1" id="t1">
          ...
          <jsp:useBean id="states" class="com.iss.models.States" scope="request">
                ...
                <% 
                    try {
                        ...
                        response.sendRedirect("StatesAdd.jsp");
                    } catch(Exception ex) {
                        ex.printStackTrace();        
                    }
                %>
